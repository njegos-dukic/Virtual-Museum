...
INSERT INTO VirtualMuseum.USER VALUES (0, 'admin', 'admin', 'Administrator', '1', 'admin@admin.com', 0, 1, 'admintoken', 1, 0, 0),
									  (0, 'user', 'user', 'User', '1', 'user@user.com', 0, 0, null, 1, 0, 0);
